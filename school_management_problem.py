1.list show nehi ho raha hai.
2.line 38 meh class ke andar hame ek folder banake uske andar class number deke list file dena hai. par mera class number wala folder schhols folder ke andar ban raha hai.i think path problem hai but samajh nehi aa raha.
import os
